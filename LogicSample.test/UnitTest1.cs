...
namespace LogicSample.test
{
    ...
    public class UnitTest1
    {
        ...
        public void TestGetAllUsers()
        {
            ...
            Assert.AreEqual("Name 1", result[0].Name); // Assert = visam jaizpildas lai tests butu veiksmīgs 
            //sagaidītā vērtība un reāla vērtība
        ...
        public void TestCreateUser()
        {
            ...
            Assert.IsTrue(user.Id > 0); // nosacījumam jābūt patiesām
        }
        [TestMethod]
